...
client.on('message', message => {
    ...
    if(message.content.includes('discord.gg')){
        ...
        message.delete()
    return message.reply(`** No Invite Links لاتنشر لا ألعن خلقتك 😠 ! **`)
    }
});
...
client.on("message", message => {
 if (message.content === "#help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© Premium Bot:ZW0V: جميع الحقوق محفوظة 2018 لــبوت')
	  ...
	  .addField('-clear', `البوت يمسح  1000 رسايل`)
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© Premium Bot:ZW0V: جميع الحقوق محفوظة 2018 لــبوت')
      .addField('شكرا لك لاستخدامك ل بروميوم بوت', `https://discordapp.com/api/oauth2/authorize?client_id=398966164467875854&permissions=8&scope=bot`)
  message.author.send({embed});
...
client.on("message", message => {
 if (message.content === "-support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© Premium Bot:ZW0V: جميع الحقوق محفوظة 2018 لــبوت')  
      .addField('سيرفر الدعم الفني', `  https://discord.gg/bcC94Mh  `)
  message.author.send({embed});
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`in 1 server -help`,"http://twitch.tv/zw0v")
...
client.on('message', message => {
  ...
  if (message.content.startsWith('-ZW')){
   if(!message.author.id === 'you fa**in id') return;
...
client.login("Mzk4OTY2MTY0NDY3ODc1ODU0.DXbLBA.bLVtwA8t1cHjTdMyHcMqRc_H3uU");